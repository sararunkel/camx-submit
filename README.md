...
unset F90FLAGS
setenv FC ifort
./configure --prefix=/GWSPH/home/vtinney/mpi
make
make install

# Verify that libraries and executables were built

ls -l /GWSPH/home/vtinney/mpi/lib/libmpich.a
ls -l /GWSPH/home/vtinney/mpi/mpich-3.0.4/lib/libmpl.a
ls -l /GWSPH/home/vtinney/mpi/bin/mpiexec
...
# Under "NUMPROCS" this is the number of processors you are allocating and is the sum of the
# processors (:1) for the nodes specified above.
...
#==========================================================================================
# Create the below bash script to run the test model with MPI. The nodes specified should
# match those that you specified in the runfile (CAMx_v7.20.36.12.20160610-11.MPICH3.job)
